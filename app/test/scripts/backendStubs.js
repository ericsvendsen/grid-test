(function () {
    ...
    angular.module('gridTest').config(function ($provide) {
        ...
        // Ingests Status
        var ingestsStatusRegex = new RegExp('^' + gridTestConfig.urls.apiPrefix + 'ingests/status/', 'i');
        ...
        var ingestsRegex = new RegExp('^' + gridTestConfig.urls.apiPrefix + 'ingests/', 'i');
        ...
        // Job load
        var jobLoadRegex = new RegExp('^' + gridTestConfig.urls.apiPrefix + 'load/', 'i');
        ...
        var jobDetailsRegex = new RegExp('^' + gridTestConfig.urls.apiPrefix + 'jobs/.*/', 'i');
        ...
        var jobTypeStatusRegex = new RegExp('^' + gridTestConfig.urls.apiPrefix + 'job-types/status/', 'i');
        ...
        var runningJobsRegex = new RegExp('^' + gridTestConfig.urls.apiPrefix + 'job-types/running/', 'i');
        ...
        var jobTypeDetailsRegex = new RegExp('^' + gridTestConfig.urls.apiPrefix + 'job-types/.*/', 'i');
        ...
        var jobExecutionLogRegex = new RegExp('^' + gridTestConfig.urls.apiPrefix + 'job-executions/.*/logs/', 'i');
        ...
        var metricsPlotDataRegex = new RegExp('^' + gridTestConfig.urls.apiPrefix + 'metrics/.*/.*/','i');
        ...
        // Metrics Detail
        var metricsDetailRegex = new RegExp('^' + gridTestConfig.urls.apiPrefix + 'metrics/.*/','i');
        ...
        var metricsRegex = new RegExp('^' + gridTestConfig.urls.apiPrefix + 'metrics/','i');
        ...
        var nodeStatusRegex = new RegExp('^' + gridTestConfig.urls.apiPrefix + 'nodes/status/', 'i');
        ...
        var nodeRegex = new RegExp('^' + gridTestConfig.urls.apiPrefix + 'nodes/.*/', 'i');
        ...
        var nodesRegex = new RegExp('^' + gridTestConfig.urls.apiPrefix + 'nodes/', 'i');
        ...
        var queueStatusRegex = new RegExp('^' + gridTestConfig.urls.apiPrefix + 'queue/status/', 'i');
        ...
        var recipeDetailsRegex = new RegExp('^' + gridTestConfig.urls.apiPrefix + 'recipes/.*/', 'i');
        ...
        var recipesRegex = new RegExp('^' + gridTestConfig.urls.apiPrefix + 'recipes/', 'i');
        ...
        var recipeTypeValidationRegex = new RegExp('^' + gridTestConfig.urls.apiPrefix + 'recipe-types/validation/', 'i');
        ...
        var recipeTypeDetailsRegex = new RegExp('^' + gridTestConfig.urls.apiPrefix + 'recipe-types/.*/', 'i');
        ...
        var recipeTypesRegex = new RegExp('^' + gridTestConfig.urls.apiPrefix + 'recipe-types/', 'i');
        ...
        // Save Recipe Type
        var recipeTypeSaveRegex = new RegExp('^' + gridTestConfig.urls.apiPrefix + 'recipe-types/', 'i');
        ...
        var statusRegex = new RegExp('^' + gridTestConfig.urls.apiPrefix + 'status/', 'i');
        ...
        var versionRegex = new RegExp('^' + gridTestConfig.urls.apiPrefix + 'v3/version/', 'i');
        ...
        var workspaceDetailsRegex = new RegExp('^' + gridTestConfig.urls.apiPrefix + 'workspaces/.*/', 'i');
        ...
        var workspacesRegex = new RegExp('^' + gridTestConfig.urls.apiPrefix + 'workspaces/', 'i');
        ...
        var workspaceCreateRegex = new RegExp('^' + gridTestConfig.urls.apiPrefix + 'workspaces/', 'i');
