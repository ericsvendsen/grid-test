(function () {
    ...
    angular.module('gridTest').factory('JobType', function (gridTestConfig) {
        ...
        JobType.prototype = {
            ...
            getIcon: function () {
                return this.icon_code ? '<i class="fa fa-fw">&#x' + this.icon_code + '</i>' : '<i class="fa fa-fw">&#x' + gridTestConfig.defaultIconCode + '</i>';
            },
            getCellText: function () {
                return this.icon_code ? '&#x' + this.icon_code + ';' : '&#x' + gridTestConfig.defaultIconCode + ';';
            },
