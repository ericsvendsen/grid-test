(function () {
    ...
    angular.module('gridTest').factory('Job', function (gridTestConfig, JobType, gridTestService) {
        var Job = function (id, job_type, job_type_rev, event, error, status, priority, num_exes, timeout, max_tries, cpus_required, mem_required, disk_in_required, disk_out_required, created, queued, started, ended, last_status_change, last_modified) {
            ...
            this.created_formatted = moment.utc(created).format(gridTestConfig.dateFormats.day_second_utc_nolabel);
            this.queued = queued;
            this.started = started;
            this.ended = ended;
            this.last_status_change = last_status_change;
            this.last_modified = last_modified;
            this.last_modified_formatted = moment.utc(last_modified).format(gridTestConfig.dateFormats.day_second_utc_nolabel);
        };
        ...
        Job.prototype = {
            getDuration: function () {
                ...
                return gridTestService.calculateDuration(start, end);
            }
        };
